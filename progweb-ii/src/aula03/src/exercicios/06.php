<form method="POST">
    <input type="number" name="peso" step="0.1" id="peso" placeholder="Peso" required min="1">
    <input type="number" name="altura" step="0.01" id="altura" placeholder="Altura" required min="1">
